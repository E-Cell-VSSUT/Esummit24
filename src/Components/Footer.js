    ...
    <footer
      ...
      <div
        ...
        <div className="flex justify-center">
          ...
          <a href="https://www.instagram.com/ecellvssut/?hl=en" className="mr-6 text-neutral-600 dark:text-neutral-200 hover:no-underline hover:text-cyan-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
          ...
          <a href="https://in.linkedin.com/company/ecellvssut" className="mr-6 text-neutral-600 dark:text-neutral-200 hover:no-underline hover:text-cyan-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
          ...
          <a href='https://github.com/E-Cell-VSSUT' className="text-neutral-600 dark:text-neutral-200 hover:no-underline hover:text-cyan-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
