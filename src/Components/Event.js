          ...
          <div className="ec">
            ...
            <div className="econ">
              ...
              <div className="flex justify-center items-center gap-5">
                <div className="flex event-button justify-center items-center gap-5 bg-[#1a57db93] text-white text-[13px] w-[100px] h-[40px] rounded-lg cursor-pointer" >
                <button><Link className=" hover:no-underline hover:text-neutral-50 main-font " target="blank" to={item.regUrl} >Register</Link></button>
                </div>
